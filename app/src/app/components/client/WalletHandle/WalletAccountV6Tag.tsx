...
export default function WalletAccountV6Tag() {
  ...
  const handleShield = async () => {
    ...
    // Must exceed the pool's per-operation privacy fee (6 STRK on mainnet),
    // otherwise the deposit cannot cover its own fee and the wallet rejects it
    // with "not enough private balance for the amount and the privacy fee".
